...
var cartCounter = document.querySelector("#cartCounter"); // socket connection
...
socket.on("orderUpdated", function (data) {
  ...
  updatedOrder.updatedAt = moment__WEBPACK_IMPORTED_MODULE_2___default()(data.updatedAt).format("hh:mm A");
